...
public class SpotlightDetection : MonoBehaviour
{
    ...
    public string enemyLayerName = "Enemy"; // Name of the wall layer
    ...
    void Start()
    {
        ...
        layerMask = (1 << playerLayer) | (1 << wallLayer) | (1 << enemyLayer);
    }
    void Update()
    {
    ...
    public bool EnemyInSpotLight(Transform enemy)
    {
        Transform[] enemySpots = enemy.GetComponent<ThreeEnemyBase>().enemySpots;
        if (spotlight.intensity > 800)
        {
