...
namespace PixelCrushers.DialogueSystem.Articy.Articy_4_0
{
    ...
    /// <summary>
    /// This static utility class contains tools to convert articy:draft 4.0 XML data into
    /// a schema-independent ArticyData object.
    /// </summary>
    public static class Articy_4_0_Tools
    {
        ...
        {
            return ArticyTools.DataContainsSchemaId(xmlFilename, "http://www.articy.com/schemas/articydraft/4.0/XmlContentExport_FullProject.xsd");
        }
